...
public sealed class TV_RLPRO : CustomPostProcessVolumeComponent, IPostProcessComponent
{
    ...
    public override void Render(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination)
    {
		...
		//m_Material.SetFloat("resolutionH", camera.camera.scaledPixelHeight);
		//m_Material.SetFloat("resolutionW", camera.camera.scaledPixelWidth);
		
		//Debug.Log(camera.camera.scaledPixelWidth + "    " + camera.camera.scaledPixelHeight);
